...
// mysql을 사용하기 위해서 MySQL api가 필요합니다. 아래 명령어로 설치 가능합니다.
...
int main()
{
	...
	*/
	if (!mysql_real_connect(&mysql_handle, "localhost", "root", "root", "unix_omok", 3306, (char *)NULL, 0)) {
	...
	// 쿼리문을 만드는 과정(흑 id, 백 id, 승자, 플레이 시간을 기록)
